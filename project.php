                  ...
                  <div class="container">
                        <div class="row">
                              <div class="col-lg-6 prev">
                                    <p><ion-icon name="arrow-back" onclick="location.href='project.php'"></ion-icon>previous</p>
                              </div>
                              <div class="col-lg-6 next">
                                    <p>next<ion-icon name="arrow-forward" onclick="location.href='project.php'"></ion-icon></p>
                              </div>
                        </div>
                  </div>
            </div>
